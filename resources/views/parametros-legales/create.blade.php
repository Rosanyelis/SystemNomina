        ...
        <form method="POST" action="{{ route('parametros-legales.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <x-ui.form-field>
                    ...
                    <x-ui.input id="salario_minimo" name="salario_minimo" type="number" step="0.01" :value="old('salario_minimo')" required />
                    <x-input-error :messages="$errors->get('salario_minimo')" />
                </x-ui.form-field>
                <x-ui.form-field>
                    <x-ui.label for="valor_ut">{{ __('Valor UT (Bs.)') }}</x-ui.label>
                    <x-ui.input id="valor_ut" name="valor_ut" type="number" step="0.01" :value="old('valor_ut')" required />
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                <x-ui.form-field>
                    ...
                    <x-ui.input id="porcentaje_ivss" name="porcentaje_ivss" type="number" step="0.01" :value="old('porcentaje_ivss')" required />
                    <x-input-error :messages="$errors->get('porcentaje_ivss')" />
                </x-ui.form-field>
                <x-ui.form-field>
                    <x-ui.label for="porcentaje_faov">{{ __('FAOV (%)') }}</x-ui.label>
                    <x-ui.input id="porcentaje_faov" name="porcentaje_faov" type="number" step="0.01" :value="old('porcentaje_faov')" required />
                    <x-input-error :messages="$errors->get('porcentaje_faov')" />
                </x-ui.form-field>
                <x-ui.form-field>
                    <x-ui.label for="porcentaje_rpe">{{ __('RPE (%)') }}</x-ui.label>
                    <x-ui.input id="porcentaje_rpe" name="porcentaje_rpe" type="number" step="0.01" :value="old('porcentaje_rpe')" required />
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <x-ui.form-field>
                    ...
                    <x-ui.input id="vigencia_desde" name="vigencia_desde" type="date" :value="old('vigencia_desde')" required />
                    <x-input-error :messages="$errors->get('vigencia_desde')" />
                </x-ui.form-field>
                <x-ui.form-field>
                    <x-ui.label for="vigencia_hasta">{{ __('Vigencia hasta (opcional)') }}</x-ui.label>
                    <x-ui.input id="vigencia_hasta" name="vigencia_hasta" type="date" :value="old('vigencia_hasta')" />
