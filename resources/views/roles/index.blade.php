                            ...
                            <div class="flex items-center justify-end gap-2">
                                ...
                                @if ($role->name !== 'Super Admin')
                                    <x-ui.confirm-modal
                                        ...
                                        :message="__('¿Está seguro de eliminar el rol «:name»? Esta acción no se puede deshacer.', ['name' => $role->name])"
                                        :confirm-text="__('Eliminar')"
                                        type="danger"
                                    >
                                        <x-ui.button type="button" variant="danger" size="sm" title="{{ __('Eliminar registro') }}">
